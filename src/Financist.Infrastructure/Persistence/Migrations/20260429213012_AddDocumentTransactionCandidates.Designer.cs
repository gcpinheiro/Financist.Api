...
namespace Financist.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260429213012_AddDocumentTransactionCandidates")]
    partial class AddDocumentTransactionCandidates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Financist.Domain.Entities.DocumentTransactionCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("InstallmentGroupKey")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                    ...
                    b.HasIndex("InstallmentGroupKey");

                    b.HasIndex("TransactionId");

                    b.HasIndex("DocumentImportId", "Status");

                    b.HasIndex("UserId", "ImportFingerprint")
                        .IsUnique();

                    b.ToTable("document_transaction_candidates", (string)null);
                });
            ...
            modelBuilder.Entity("Financist.Domain.Entities.DocumentTransactionCandidate", b =>
                {
                    ...
                    b.HasOne("Financist.Domain.Entities.Transaction", "Transaction")
                        .WithMany()
                    ...
                    b.OwnsOne("Financist.Domain.ValueObjects.Money", "Amount", b1 =>
                        {
                            b1.Property<Guid>("DocumentTransactionCandidateId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("DocumentTransactionCandidateId");

                            b1.ToTable("document_transaction_candidates");

                            b1.WithOwner()
                                .HasForeignKey("DocumentTransactionCandidateId");
                        });
